...
namespace TMS.Data.Migrations
{
    ...
    [Migration("20220306203055_RecieptDataWithRecieptParam")]
    partial class RecieptDataWithRecieptParam
    {
            ...
            modelBuilder.Entity("TMS.Data.Entities.DenominationParamValueMode", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreationDate = new DateTime(2022, 3, 6, 22, 30, 54, 590, DateTimeKind.Local).AddTicks(4321),
                            Name = "FIXED"
                        },
                        new
                        {
                            ID = 2,
                            CreationDate = new DateTime(2022, 3, 6, 22, 30, 54, 591, DateTimeKind.Local).AddTicks(3285),
                            Name = "DYNAMIC"
                        });
                });
            ...
            modelBuilder.Entity("TMS.Data.Entities.DenominationParamValueType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreationDate = new DateTime(2022, 3, 6, 22, 30, 54, 592, DateTimeKind.Local).AddTicks(7249),
                            Name = "Number"
                        },
                        new
                        {
                            ID = 2,
                            CreationDate = new DateTime(2022, 3, 6, 22, 30, 54, 592, DateTimeKind.Local).AddTicks(7261),
                            Name = "String"
                        },
                        new
                        {
                            ID = 3,
                            CreationDate = new DateTime(2022, 3, 6, 22, 30, 54, 592, DateTimeKind.Local).AddTicks(7262),
                            Name = "List"
                        },
                        new
                        {
                            ID = 4,
                            CreationDate = new DateTime(2022, 3, 6, 22, 30, 54, 592, DateTimeKind.Local).AddTicks(7264),
                            Name = "Date"
                        });
                });
            ...
            modelBuilder.Entity("TMS.Data.Entities.DenominationReceiptParam", b =>
                {
                    ...
                    b.Property<int?>("DenominationReceiptDataID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DenominationReceiptDataID");
            ...
            modelBuilder.Entity("TMS.Data.Entities.PendingPaymentCardStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreationDate = new DateTime(2022, 3, 6, 22, 30, 54, 608, DateTimeKind.Local).AddTicks(463),
                            Name = "Initiated",
                            NameAr = "بدأت"
                        },
                        new
                        {
                            ID = 2,
                            CreationDate = new DateTime(2022, 3, 6, 22, 30, 54, 608, DateTimeKind.Local).AddTicks(517),
                            Name = "Canceled",
                            NameAr = "ألغيت"
                        },
                        new
                        {
                            ID = 3,
                            CreationDate = new DateTime(2022, 3, 6, 22, 30, 54, 608, DateTimeKind.Local).AddTicks(518),
                            Name = "Confirmed",
                            NameAr = "مؤكد"
                        },
                        new
                        {
                            ID = 4,
                            CreationDate = new DateTime(2022, 3, 6, 22, 30, 54, 608, DateTimeKind.Local).AddTicks(519),
                            Name = "AutoCanceled",
            ...
            modelBuilder.Entity("TMS.Data.Entities.DenominationReceiptParam", b =>
                {
                    ...
                    b.HasOne("TMS.Data.Entities.DenominationReceiptData", "DenominationReceiptData")
                        .WithMany("DenominationReceiptParams")
                        .HasForeignKey("DenominationReceiptDataID")
                        .OnDelete(DeleteBehavior.NoAction);
