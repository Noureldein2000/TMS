...
namespace TMS.Data.Migrations
{
    ...
    [Migration("20220224133047_AddFontSizeAndValidationMessageAr")]
    partial class AddFontSizeAndValidationMessageAr
    {
            ...
            modelBuilder.Entity("TMS.Data.Entities.DenominationParamValueMode", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreationDate = new DateTime(2022, 2, 24, 15, 30, 47, 499, DateTimeKind.Local).AddTicks(1079),
                            Name = "FIXED"
                        },
                        new
                        {
                            ID = 2,
                            CreationDate = new DateTime(2022, 2, 24, 15, 30, 47, 500, DateTimeKind.Local).AddTicks(948),
                            Name = "DYNAMIC"
                        });
                });
            ...
            modelBuilder.Entity("TMS.Data.Entities.DenominationParamValueType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreationDate = new DateTime(2022, 2, 24, 15, 30, 47, 501, DateTimeKind.Local).AddTicks(3357),
                            Name = "Number"
                        },
                        new
                        {
                            ID = 2,
                            CreationDate = new DateTime(2022, 2, 24, 15, 30, 47, 501, DateTimeKind.Local).AddTicks(3367),
                            Name = "String"
                        },
                        new
                        {
                            ID = 3,
                            CreationDate = new DateTime(2022, 2, 24, 15, 30, 47, 501, DateTimeKind.Local).AddTicks(3368),
                            Name = "List"
                        },
                        new
                        {
                            ID = 4,
                            CreationDate = new DateTime(2022, 2, 24, 15, 30, 47, 501, DateTimeKind.Local).AddTicks(3369),
                            Name = "Date"
                        });
                });
            ...
            modelBuilder.Entity("TMS.Data.Entities.PendingPaymentCardStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreationDate = new DateTime(2022, 2, 24, 15, 30, 47, 515, DateTimeKind.Local).AddTicks(9550),
                            Name = "Initiated",
                            NameAr = "بدأت"
                        },
                        new
                        {
                            ID = 2,
                            CreationDate = new DateTime(2022, 2, 24, 15, 30, 47, 515, DateTimeKind.Local).AddTicks(9608),
                            Name = "Canceled",
                            NameAr = "ألغيت"
                        },
                        new
                        {
                            ID = 3,
                            CreationDate = new DateTime(2022, 2, 24, 15, 30, 47, 515, DateTimeKind.Local).AddTicks(9610),
                            Name = "Confirmed",
                            NameAr = "مؤكد"
                        },
                        new
                        {
                            ID = 4,
                            CreationDate = new DateTime(2022, 2, 24, 15, 30, 47, 515, DateTimeKind.Local).AddTicks(9612),
                            Name = "AutoCanceled",
