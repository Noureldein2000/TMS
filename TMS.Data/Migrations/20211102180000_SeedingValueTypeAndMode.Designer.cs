            ...
            modelBuilder.Entity("TMS.Data.Entities.DenominationParamValueMode", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreationDate = new DateTime(2021, 11, 2, 20, 0, 0, 47, DateTimeKind.Local).AddTicks(5663),
                            Name = "FIXED"
                        },
                        new
                        {
                            ID = 2,
                            CreationDate = new DateTime(2021, 11, 2, 20, 0, 0, 48, DateTimeKind.Local).AddTicks(8851),
                            Name = "DYNAMIC"
                        });
                });
            ...
            modelBuilder.Entity("TMS.Data.Entities.DenominationParamValueType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreationDate = new DateTime(2021, 11, 2, 20, 0, 0, 50, DateTimeKind.Local).AddTicks(5486),
                            Name = "Number"
                        },
                        new
                        {
                            ID = 2,
                            CreationDate = new DateTime(2021, 11, 2, 20, 0, 0, 50, DateTimeKind.Local).AddTicks(5499),
                            Name = "String"
                        },
                        new
                        {
                            ID = 3,
                            CreationDate = new DateTime(2021, 11, 2, 20, 0, 0, 50, DateTimeKind.Local).AddTicks(5501),
                            Name = "List"
                        },
                        new
                        {
                            ID = 4,
                            CreationDate = new DateTime(2021, 11, 2, 20, 0, 0, 50, DateTimeKind.Local).AddTicks(5502),
                            Name = "Date"
                        });
                });
