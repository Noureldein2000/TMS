...
namespace TMS.Services.ProviderLayer
{
    public class OrangeMobile : IBaseProvider
    {
        ...
        public async Task<InquiryResponseDTO> Inquiry(InquiryRequestDTO inquiryModel, int userId, int id, int serviceProviderId)
        {
            ...
            string url = switchEndPoint.URL + "requestID=" + providerServiceRequestId + "&mobile=" + inquiryModel.BillingAccount + "&userName=" + switchEndPoint.UserName + "&password=" + switchEndPoint.UserPassword;
